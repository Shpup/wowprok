    ...
    <div class="container mx-auto p-6">
        ...
        <div class="flex flex-row gap-8">
            ...
            <div class="w-1/3 bg-white rounded-lg shadow-lg p-6 h-fit">
                ...
                <div id="categoryTree" class="category-tree space-y-3">
                    <?php $__currentLoopData = \App\Models\Category::whereNull('parent_id')->with('children', 'user')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('equipment.category-item', ['category' => $category, 'depth' => 0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div id="equipmentList">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <?php if($equipment->isEmpty()): ?>
                            <tr>
                                <td colspan="<?php echo e(Auth::user()->hasPermissionTo('view prices') ? 5 : 4); ?>" class="px-6 py-4 text-center text-gray-600">Нет оборудования в этой категории</td>
                            </tr>
                        <?php else: ?>
                            <?php $__currentLoopData = $equipment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50" data-id="<?php echo e($item->id); ?>">
                                    <td class="px-6 py-4"><?php echo e($item->name); ?></td>
                                    <td class="px-6 py-4">
                                        <?php if($item->barcode): ?>
                                            <img src="<?php echo e(Storage::url($item->barcode)); ?>" alt="Штрихкод" class="h-16 w-16">
                                        <?php else: ?>
                                            Нет штрихкода
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <?php endif; ?>
                                    <td class="px-6 py-4">
                                        <?php if($item->projects->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $item->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="text-sm text-gray-600"><?php echo e($project->pivot->status); ?> (<?php echo e($project->name); ?>)</span><br>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            На складе
                                        <?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit projects')): ?>
                                        <td class="px-6 py-4">
                                            <button onclick="editEquipment(<?php echo e($item->id); ?>)" class="text-blue-600 hover:underline mr-4">Редактировать</button>
                                            <button onclick="deleteEquipment(<?php echo e($item->id); ?>)" class="text-red-600 hover:underline">Удалить</button>
                                        </td>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <form id="createCategoryForm" action="<?php echo e(route('categories.store')); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="parent_id" id="parent_id" class="mt-1 block w-full border-gray-300 rounded-md">
                            ...
                            <?php $__currentLoopData = \App\Models\Category::where('user_id', auth()->id())->orWhere('user_id', null)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="createEquipmentModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center hidden z-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-lg">
                ...
                <form id="createEquipmentForm" action="<?php echo e(route('equipment.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<script>
    ...
    window.openEquipmentModal = function(categoryId) {
        ...
        document.getElementById('createEquipmentForm').action = '<?php echo e(route('equipment.store')); ?>';
    ...
    window.editEquipment = function(id) {
        fetch(`/equipment/${id}/edit`, {
            ...
            .then(data => {
                ...
                if (data.image) {
                    document.getElementById('imagePreview').src = '<?php echo e(Storage::url('/')); ?>' + data.image;
...
<?php /**PATH C:\Users\polio\Desktop\main_prokat\main_prokat1\resources\views/equipment/index.blade.php ENDPATH**/ ?>